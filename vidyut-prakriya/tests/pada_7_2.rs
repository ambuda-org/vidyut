...
#[test]
fn sutra_7_2_50() {
    let klish_div = Dhatu::new("kliSa~\\", Divadi);
    ...
    let klish_kri = Dhatu::new("kliSU~\\", Kryadi);
...
fn sutra_7_2_52() {
    ...
    let kzudh = Dhatu::new("kzu\\Da~", Divadi);
