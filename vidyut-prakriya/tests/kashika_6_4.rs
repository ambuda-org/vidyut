...
#[test]
fn sutra_6_4_4() {
    assert_has_sup_6p("tisf", Stri, &["tisfRAm"]);
    assert_has_sup_6p("catasf", Stri, &["catasfRAm"]);
}
...
fn sutra_6_4_55() {
    ...
    // Ayya
    assert_has_krdanta(&[], &spfha, Krt::Ayya, &["spfhayAyya"]);
    assert_has_krdanta(&[], &gfha, Krt::Ayya, &["gfhayAyya"]);
    // itnu
...
fn sutra_6_4_68() {
    ...
    // kNiti
    assert_has_ashirlin_karmani(&[], &glai, &["glAsIzwa", "glAyizIzwa"]);
    // aNgasya
