...
fn generate_pr_demo_output() {
    ...
    let mut rigveda_lipika = Lipika::new().with_extension(rigveda_shakala());
    ...
    let mut yajurveda_lipika = Lipika::new().with_extension(yajurveda_taittiriya());
    ...
    let mut samaveda_lipika = Lipika::new().with_extension(samaveda_kauthuma());
    ...
    let mut atharvaveda_lipika = Lipika::new().with_extension(atharvaveda_shaunaka());
    ...
    println!("---");
    println!(
        "*Generated automatically to verify transliteration accuracy across Vedic traditions*"
    );
}
