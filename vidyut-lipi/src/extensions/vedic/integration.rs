...
impl TransliterationExtension for UnifiedVedicExtension {
    ...
    fn extend_mapping(&self, mapping: &mut Mapping) {
        ...
        match (from_scheme, to_scheme) {
            ...
            (from, crate::Scheme::Devanagari) if matches!(from, crate::Scheme::HarvardKyoto | crate::Scheme::Velthuis | crate::Scheme::Slp1) => {
                mapping.add_mapping("=", "\u{0951}", SpanKind::Accent); // udatta (new)
                mapping.add_mapping("'", "\u{0951}", SpanKind::Accent); // udatta (legacy)
                mapping.add_mapping("_", "\u{0952}", SpanKind::Accent); // anudatta
            }
            // From Devanagari to ASCII-only schemes: reverse mapping
            (crate::Scheme::Devanagari, to) if matches!(to, crate::Scheme::HarvardKyoto | crate::Scheme::Velthuis | crate::Scheme::Slp1) => {
                mapping.add_mapping("\u{0951}", "=", SpanKind::Accent); // udatta (new ASCII-only)
                mapping.add_mapping("\u{0952}", "_", SpanKind::Accent); // anudatta
            }
            // From Unicode schemes (ISO/IAST) to Devanagari: use combining marks
            (from, crate::Scheme::Devanagari) if matches!(from, crate::Scheme::Iso15919 | crate::Scheme::Iast) => {
            ...
            (crate::Scheme::Devanagari, to) if matches!(to, crate::Scheme::Iso15919 | crate::Scheme::Iast) => {
        ...
        match (from_scheme, to_scheme) {
            ...
            (_, to) if matches!(to, crate::Scheme::HarvardKyoto | crate::Scheme::Wx | crate::Scheme::Slp1 | crate::Scheme::Velthuis) => {
